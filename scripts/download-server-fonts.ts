...
const NOTO_SERIF_JP_FAMILY = 'Noto Serif JP'
...
const fonts = [
  ...
  { family: NOTO_SERIF_JP_FAMILY, weight: 400, filename: 'noto-serif-jp-400.ttf' },
  { family: NOTO_SERIF_JP_FAMILY, weight: 700, filename: 'noto-serif-jp-700.ttf' },
