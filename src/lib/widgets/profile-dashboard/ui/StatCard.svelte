<script lang="ts">
  ...
  import type { StatItem } from '$lib/entities/github-stats/model/stat-items'
  import type { TiltState } from '$lib/shared/lib/mouse-tilt'
  import { tiltStyle, shineStyle } from '$lib/shared/lib/mouse-tilt'
